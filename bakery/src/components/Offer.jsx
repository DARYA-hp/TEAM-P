...
function Offer() {
    ...
    return (
        <>
            <div className="flex relative pt-[60px] items-center text-center gap-12  flex-col">
                <div className="flex flex-col gap-5">
                    <div>
                        <p className=" pt-10 text-[36px] font-[700]">What we offer</p>
                        <img src="/Line 4.png" alt="" className=" pl-32" />
                    </div>
                    <p className=" w-[500px] text-[18px] ">Introducing you a wide variety of bakery items with unique taste and the creamiest of cakes in the city.</p>
                </div>
                ...
                <div className="absolute inset-0 w-full h-full">
                    ...
                    <img src="/Cupcake.png" alt=""
                        className="w-[80] h-[80] absolute top-[180px] left-[70px] rotate-[0deg] transition-transform duration-500 hover:translate-y-[-10px]"/>
                    <img src="/Toast.png" alt=""
                        className="w-[80] h-[80] absolute top-20 right-[310px] rotate-[10deg] transition-transform duration-500 hover:translate-x-[10px]"/>
                </div>
